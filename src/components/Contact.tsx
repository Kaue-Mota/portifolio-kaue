...
const Contact = ({ lang }: { lang: Lang }) => {
  ...
  const contactItems = [
    { label: t.contact_email, value: "pckaue1234@gmail.com", href: "mailto:pckaue1234@gmail.com" },
    { label: t.contact_phone, value: "(61) 99101-4779", href: "https://wa.me/5561993375795" },
    { label: t.contact_location, value: t.contact_location_value, href: null },
  ];
  ...
  return (
    <section id="contato" className="section-padding relative overflow-hidden">
      ...
      <div className="editorial-container relative z-10">
        <AnimatedSection>
          <h2 className="headline-lg text-foreground mb-2">{t.section_contact}</h2>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-7 space-y-4">
            ...
            <AnimatedSection delay={0.15}>
              <a
                href="https://wa.me/5561993375795"
                target="_blank"
